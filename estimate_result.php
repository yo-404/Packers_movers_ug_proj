...
<div class="container col-sm-10" style="text-align: center; border: 1px solid black; border-radius: 20px; margin-top: 20px; margin-bottom: 20px;">
	<h3>Your Estimated Cost is </h3><hr>
	...
	<form method="post" action="estimate_backend.php" onsubmit="return itemsSelected()" enctype="multipart/form-data">
		...
		<!-- Living Room Details Ends Here -->
			...
			<div class="row">
				...
				<div class="col-sm-4">
                    <a href="estimate.php">
                    <input type=button class="btn btn-warning"Value="Calculate again?">
                    </A>
				</div>
			</div>
		...
		<div class="row">
			<div class="col">
                <p>Satisfied with the cost ? want to book a slot for moving ur goods</p><br>
                <a href="calculate_cost.php">
                    <input type=button class="btn btn-success"Value="Book a slot">
                    </A>
