<html>
	<body style="background-color:	#ebffe8;">
...
function fun()
{
	...
	if(distance<0)
	alert("distance cannot be a negetive value");
	...
	<form method="post" action="calculate_cost_backend.php" onsubmit="return itemsSelected()" enctype="multipart/form-data">
		...
		<!-- Living Room Details Ends Here -->
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<button class="btn btn-success" name="calculated_cost_button" onClick="fun()" >Proceed to Next Step</button>
				</div>
			</div>
