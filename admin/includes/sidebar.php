 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>Admin System</h1></span> 
...
{               ?>
    ...
    <div class="menu">
        <ul id="menu" >
        <li id="menu-academico" ><a href="#"><i class="fa fa-user"></i> <span>Manage Admin</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="admin-profile.php">Profile show/update</a></li>
                    <li id="menu-academico-boletim" ><a href="change-password.php">Reset Password</a></li>
            ...
            <li><a href="manage-client.php" ><i class="fa fa-table"></i> <span>Users List</span></a></li>
            <li><a href="payment-details.php" ><i class="fa fa-file-text-o"></i> <span>Payment Log</span></a></li>
