...
<?php include 'header.php' ?>
	...
	<?php
    $payment=$_SESSION['calculated_cost'];
...
<?php
						...
						{ 
							$payment = intval($_SESSION['calculated_cost']);
							echo '<p><center>Payment form for Rs.'.$payment.'</center></p>';
						}
						?>
			...
			<tbody>
				...
				<tr>
					...
					<td><input title="TXN_AMOUNT" tabindex="10"
						...
						value="<?php echo $payment; ?>"readonly>
					</td>
				</tr>
				<tr>
					<!-- <td></td> -->
					<td></td>
					<td><input value="CheckOut" type="submit"	onclick="val"></td>
				</tr>
			</tbody>
		</table>
		* - Mandatory Fields
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate >
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="address" placeholder="House/Flat" required>
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              <label for="address2">Locality/City <span class="text-muted"></span></label>
              <input type="text" class="form-control" id="address2" placeholder="Area/Lane" required>
            </div>
            ...
            <hr class="mb-4">
            <!-- <button class="btn btn-primary btn-lg btn-block" type="submit" value="CheckOut" onclick="">Continue to checkout</button> -->
          </form>
        </div>
      </div>
